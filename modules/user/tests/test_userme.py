...
class CreateUserTestView(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = '/api/v1/actuarial/users/me/'
        cls.user_me = APIClient()
    
    def test_user_me(self):
        res = self.user_me.get(self.url, HTTP_AUTHORIZATION='Token {}'.format(self.token), content_type=self.content, HTTP_MEDIUM=self.medium, HTTP_PORTAL=self.portal)
